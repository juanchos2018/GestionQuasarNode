     ...
     <q-page class="q-pa-md">
        <h5>Fases metodologia </h5> 
         ...
         <div class="ellipsis">
          ...
          <q-btn color="primary" style="margin-left:5px"   @click="DialogoFaseElemento=true">
         <div class="ellipsis">
            + ECS
            </div>            
         </q-btn>
     <br><br>
     <q-list bordered  v-for="item in items" :key="item.key" @click="ListarElemtosFase(item.id_fase)"> 
            <q-expansion-item
                group="somegroup"
                icon="explore"
                ...
                <q-card-section>
                    <q-list bordered>
                    <q-item v-for="contact in elementos" :key="contact.id_elemento" class="q-my-sm" >
...
export default {
        ...
        methods:{
            ...
            ListarElemtosFase(faseId){
                let me=this;
                me.elementos=[];
                this.$axios.get('PlantillaElemento/'+faseId).then(response => {    
